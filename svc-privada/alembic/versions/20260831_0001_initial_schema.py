...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id_legacy", sa.String(64)),
        sa.Column("nro_expediente", sa.String(60)),
        sa.Column("origen", sa.String(30)),
        sa.Column("estado", sa.String(40), nullable=False, server_default="INGRESADO"),
        ...
        sa.Column("urgencia", sa.String(10), server_default="Media"),
        sa.Column("ministerio_agencia_id", sa.String(80)),
        sa.Column("organismo_id", sa.String(200)),
        sa.Column("derivado_a_id", sa.String(200)),
    ...
    op.create_table(
        ...
        sa.Column("estado_nuevo", sa.String(40)),
        sa.Column("campo_modificado", sa.String(60)),
